// Fully Automatic Dual Audio Transcription Service
// Automatically captures and transcribes both user microphone and meeting audio
// No buttons, no options, no user interaction - just transcribe everything automatically
...
export const useFullyAutoTranscription = () => {
  ...
  const initializeRecognition = async () => {
    ...
    recognitionRef.current.onstart = () => {
      console.log('Fully automatic dual audio transcription started');
      setIsRecording(true);
    ...
    recognitionRef.current.onend = () => {
      console.log('Fully automatic dual audio transcription ended');
  ...
  // Fully automatic transcription - starts immediately
  const startFullyAutomaticTranscription = async () => {
    ...
    try {
      ...
      console.error('Failed to start fully automatic transcription:', err);
  ...
  useEffect(() => {
    ...
    // Start transcription automatically when component mounts
    const timer = setTimeout(() => {
      startFullyAutomaticTranscription();
